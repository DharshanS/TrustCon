...
## Rajib modify - 16/10/2015
$amount          = null2unknown($_GET["vpc_Amount"]/100);
...
<html>
    ...
    <body>
        ...
        <table width="85%" align="center" cellpadding="5" border="0">
            <tr class="title">
                <td colspan="2" height="25"><P><strong>&nbsp;Basic Transaction Fields</strong></P><P style="float:right"><a href="http://www.clickmybooking.com/" title="Go to Home">Back</a></P></td>
            </tr>
            <tr>
