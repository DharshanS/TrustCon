                ...
                <div class="visl">
                               ...
                               <div class="row brd-btm "><!--Added CSS-->  
                                                              <div class="col-sm-1 flt flySeg"> 
                                                                  <label><input type="radio" class="radio-small" name="selectFlightOut"  mode="outBound_<?php echo $Key ?>"
         ...
         <?php $basePrice=$index->airPrincingInfo ?>
            <div class="col-sm-3 show-flight-prize">
                <div class="flt-prz">
                    ...
                    <input type="hidden" name="priceData" value="<?php echo base64_encode($basePrice) ?>">
