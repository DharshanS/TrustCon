...
function init_priceDisplay($response)
{
                                                ...
                                                <div class="row">
                                                        ...
                                                        <div class="first_before">
                                                           <!--[0] booking Info(class) [1] passenger details flight details Start   --->
                                                            ...
                                                            foreach($response->airDetails as $index)
                                                                ...
                                                                $classDetails='';
                                                                $cflg=false;
                                                                        if(isset($air[0]['@attributes']))
                                                                        {
                                                                          $classDetails=$air[0]['@attributes'];  
                                                                        }
                                                                        elseif($air[0] && count($air[0])>1)
                                                                        {
                                                                         $classDetails=$air[0]; 
                                                                         $cflg=true;
                                                                        }
                                                  // error_log( print_r($index,true) ); ?>
                                                            <div class="first_before_row">
                                                                <ul>
                                                                    <li><img src="../travel/airimages/<?php echo $air['Carrier'] ?>.GIF" class="icn">
                                                                        <span> <br>
                 ...
                 <?php echo $flightUtility->getCountryName($air['Destination']).' '.$air['Destination']?></strong>
                                                                    ...
                                                                    <li> <span>
                                                                        <?php if($cflg){
                                                                            ...
                                                                            {
                                                                               $cls=$item['@attributes'];
                                                                              echo $cls['CabinClass'].' ('.$cls['BookingCode'].') | '; 
                                                                            }
                                                                        } else {?>
