                                            ...
                                            <div class="col-md-9 col-lg-8 tkout_dts">
                                                <div class="row">
                                                    <div class="col-xs-6 col-lg-3 fly_seg">
                                                        <p>
                                                            <?php echo $flyInnerListTop['Origin']?></p><br>
                                                        <p> 
                                                        <input type="radio" class="flySelect" id="bestRo_<?php echo $index?>" name="flySelectOut" value="" checked="checked"> 
                                                        <?php echo date("h:i a", strtotime($flyInnerListTop['DepartureTime'])) ?>
                                                        </p><br>
                                                        <p><?php echo date("D, d M Y", strtotime($flyInnerListTop['DepartureTime']))?></p> <br>
                                                        <p> 
                                                            <span>
                                                    ...
                                                    <div class="col-xs-6 col-lg-3 fly_seg">    
                                                      <p>
                                                            <?php echo $flyInnerListTop['Destination']?></p><br>
                                                        <p> 
                                                        <input type="radio" class="flySelect" id="bestRo_<?php echo $index?>" name="flySelectOut" value="" checked="checked"> 
                                                    ...
                                                    <div class="col-xs-6 col-lg-1">
                                                     <img src="../airimages/<?php echo $flyInnerListBot['Carrier']?>.GIF">
                                                    </div>
                                                    <div class="col-xs-6 col-lg-2"><?php echo $flyUtil->getAirLineName($flyInnerListBot['Carrier'])?></div>
                                                    <div class="col-xs-6 col-lg-1"><?php
                                                                ...
                                                                ?></div>
                                                    <div class="col-xs-6 col-lg-2"><?php echo $flyUtil->getTimeDiff(date("h:i a", strtotime($flyInnerListTop['DepartureTime'])), date("h:i a", strtotime($flyInnerListBot['ArrivalTime']))) ?></div>
                                                </div>
