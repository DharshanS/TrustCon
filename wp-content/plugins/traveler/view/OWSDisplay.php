...
{?>
<div class= col-lg-3 v1_fsq">
      <p class="ow-tks-p"><?php echo $tem['Destination'] ?><br>
...
echo $airlineName ?></div> </p>
    <p  class="ow-tks-p">
<div class="col-xs-6 col-lg-1 v1_fsq"><label><?php
    ...
    ?></label></div> </p>
    <p class="ow-tks-p">
<div class="col-xs-6 col-lg-2 v1_fsq"><label>
