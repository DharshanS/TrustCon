			  ...
			  <!-- XXXX Added - Webbfaire Discount for All -->
               <tr>
                ...
                <?php
					...
					{
					 //$disAmt = (substr($tPrice,3) / 100) * $discount;
					$disAmt = ($farePrice / 100) * $discount; // Decm 23, 2016
                    ...
                    <div class="well">
                      ...
                      <ul>
                       ...
                       <!-- <li>
                        ...
                        <li>
						   <label><span> </span><br />
                             <a class="fancybox" href="<?php echo get_template_directory_uri(); ?>/images/Passport-01.jpg">Sample passport</a>
						   </label>
                        </li>						
                      </ul>
