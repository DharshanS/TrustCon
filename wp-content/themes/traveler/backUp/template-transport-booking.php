...
Template Name: Transport Booking
...
$soap ='<soapenv:Envelope xmlns:soapenv="http://schemas.xmlsoap.org/soap/envelope/">
   ...
   <soapenv:Body>
      <!-- Rajib Remarked following lone -->
	  <!--<air:AirCreateReservationReq xmlns:univ="http://www.travelport.com/schema/universal_v31_0" AuthorizedBy="user" RetainReservation="Both" TargetBranch="'.$TARGETBRANCH.'" TraceId="'.md5("ACRR".date("ymdHis")).'">-->
	...
	//print_r($responseArray);
        ...
        <script>
            $(function(){
                ...
                var errMsg = 'Fault Code:- <?php echo $responseArray['SOAPBody']['SOAPFault']['faultcode'];?><br>Description:- <?php echo $responseArray['SOAPBody']['SOAPFault']['detail']['ErrorInfo']['Description'];?>';
				errorAlert(errMsg+"<br><font style='color:red'>( Will Redirect in 5sec )</font>");
