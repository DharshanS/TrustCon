...
<div class="container-fluid">
    <div class="com-sm-12">
        ...
        <p>This is to confirm that the passenger holds a valid Sri Lankan passport and that the travel itinerary to travel from <?php echo $airportscity[$segmentdtls['Origin']];?> to <?php echo $airportscity[$segmentdtls['Destination']];?> through <?php echo $thisairlinename;?> as per confirmed by the passenger is as follows:</p>
        <table cellpadding="0" cellspacing="0" border="1" bordercolor="#ccc">
            ...
            <tr>
                <td colspan="4"><?php echo $booking_entries['title'][0];?> <?php echo $booking_entries['first_name'][0];?> <?php echo $booking_entries['last_name'][0];?></td>
                <td><?php echo $booking_entries['passport_no'][0];?></td>
            </tr>
            <tr>
                <th>FLIGHT NO</th>
                <th>DATE</th>
        ...
        <div class="row">
            ...
            <div class="col-sm-6">
                <div class="text-right ppd">
                    <h2>Customer Care:</h2>
                    <p><strong>Call :</strong> 0123456789</p>
...
<div style="width:100%; text-align:right;"><input type="button" name="btnPrint" id="btnPrint" value="Print This" /></div>
