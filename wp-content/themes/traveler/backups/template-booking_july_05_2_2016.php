...
jQuery('#step4_mail_details').html('<div style="display: block;" id="please-wait"><div class="order-loading"><div class="order-loading-content"><span class="order-loading-waiting">Please Wait a Moment</span><span class="order-loading-title">Do you know?</span><span class="order-loading-trivia">"Exchange your Tix Point with Nissan Xtrail now!"</span></div></div></div>');
