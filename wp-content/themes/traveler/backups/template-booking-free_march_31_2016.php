       ...
       <div class="booking_wrapp">
        ...
        <div class="drop_select">
        	...
        	<select name="booking_reason" id="booking_reason">
                ...
                <option value="Advance Reservation">Advance Reservation</option>
            </select>
        </div>
        </div>
       ...
       <div id="step3_details"  style="display:none;">
         ...
         <?php foreach($bookingdata['passengers'][0] as $k=>$p){?>
          <div class="form_panel"><span><strong><?php echo $ptypefull[$p];?> <?php echo $k+1;?></strong></span>
            ...
            <input type="hidden" name="ptype[]" value="<?php echo $p;?>" />
              <ul>
                ...
                <li>
                  <label><span>Other Name (Firstname)</span><br />
                    <input name="first_name[]" type="text" class="txt_box" placeholder="Other Name" />
                  </label>
                </li>
                <li>
                  <label><span>Surname (Lastname)</span><br />
                    <input name="last_name[]" type="text" class="txt_box" placeholder="Surname" />
                  </label>
                </li>
                <li>
                  <label><span>Date of Birth</span><br />
                    <input name="dob[]" type="text" class="txt_box date-pick" placeholder="Date of Birth" data-date-format="yyyy-mm-dd"  data-date-end-date="0d"/>
                  </label>
                </li>
                 <?php if($k==0){?>
                <li>
                  <label><span>Mobile No (ex 0094777123456</span>)<br />
                    <input name="phone[]" type="text" class="txt_box" placeholder="Mobile No" />
                  </label>
                </li>
               <?php }else{ ?>
               <li><label> &nbsp; </label></li>
          ...
          <div class="letter-heading-area" id="letterhead" style="display:none;">
            ...
            <textarea name="letterhead"></textarea>
          </div>
                  ...
                  <div class="payment_options">
                    <div class="payment_options_wrapp">
                      ...
                      <div class="btn_panel" align="right">
                        <input class="booking_btn" type="button" value="Continue" name="">
                        </div>
                    </div>
                  </div>
                </div>
...
<div class="pop_wrapp" id="fare-pop">
	<div class="pop_up">
        ...
        <ul>
            ...
            <li><a style="cursor:pointer;" onclick="setBookingReason(2);">Embassy Purpose</a></li>
            <li><a style="cursor:pointer;" onclick="setBookingReason(3);">Advance Booking</a></li>-->
            ...
            <li><a style="cursor:pointer;" onclick="setBookingReason(4);">Advance Reservation</a></li>
            <!-- Rajib Added-->
        </ul>
    </div>
</div>
...
jQuery("#booking_reason").change(function(){
    ...
    if(v=='Fare Quotation' || v=='Embassy Purpose'){
