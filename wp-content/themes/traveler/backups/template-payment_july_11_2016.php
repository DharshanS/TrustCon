...
$initRequest->setExtraData(array("post_id" => $post_id,"booking_type"=>$booking_type));
    ...
    <div class="container">
     <br>
	  ...
	  <ul>
        ...
        <li><a href="#"><img src="<?php echo get_template_directory_uri(); ?>/images/secure/dinner-club.jpg"></a></li>
