...
$SECURE_SECRET = "45F98EC6376767E215ADCB5384B61344";
...
## Rajib - Insert PAYMENT information after Valid Transaction
$pid = $_SESSION['post_id'];
require_once("../travelportsettings.php");
require_once("../tconnect.php");
$mysqli = new mysqli(DB_HOST, DB_USER, DB_PASSWORD, DB_NAME);

// Update into wp_postmeta
	$SQL = " UPDATE `booking` SET payment_dt = '".date('Y-m-d')."' , payment_trn_id = '".$transactionNo."' WHERE  booking_id = '".$merchTxnRef."' ";
//die($SQL);
...
<html>
    ...
    <body>
        ...
        <table width="85%" align="center" cellpadding="5" border="0">
            <tr class="title">
                <td colspan="2" height="25"><P><strong>&nbsp;Basic Transaction Fields</strong></P><P style="float:right"><a href="http://www.clickmybooking.com/" title="Go to Home">Back To Home</a></P></td>
            </tr>
            <tr>
...
function getResponseDescription($responseCode ) {
	...
	global $merchTxnRef;
	switch ($responseCode) {
        case "0" : $result = "Transaction successful. (Reference Number: ".$merchTxnRef.")"; break;
        case "?" : $result = "Transaction status is unknown"; break;
        case "1" : $result = "Transaction unsuccessful, please try again... (Reference Number: ".$merchTxnRef.")"; break;
        case "2" : $result = "Bank Declined Transaction"; break;
        case "3" : $result = "No Reply from Bank"; break;
        case "4" : $result = "Expired Card"; break;
        case "5" : $result = "Transaction rejected, please contact your bank… (Reference Number: ".$merchTxnRef.")"; break;
        case "6" : $result = "Error Communicating with Bank"; break;
        case "7" : $result = "Payment Server System Error"; break;
        case "8" : $result = "Transaction Type Not Supported"; break;
        case "9" : $result = "Bank declined transaction (Do not contact Bank)"; break;
