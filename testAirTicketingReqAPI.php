...
//
$USERNAME = 'Universal API/uAPI6986631472-c8b85ad8';
$PASSWORD = 'P+t2rJ7&M6';
$TARGETBRANCH = 'P7040105';
//
// Sample Low Fare Search request parameters:
//
$startDate = '2015-11-14'; // Outbound search date
...
//
    $soap_do = curl_init ("https://twsprofiler.travelport.com/Service/Default.ashx/B2BGateway/connect/uAPI/AirService");
//
